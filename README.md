# Phuc Le's Auto-Rice Bootstraping Scripts (PLARBS)
...
```
curl -LO github.com/plarbs/archdwm/plarbs.sh
sh plarbs.sh
```
...
PLARBS is a script that autoinstalls and autoconfigures a fully-functioning
and minimal terminal-and-vim-based Arch Linux environment.

PLARBS was originally intended to be run on a fresh install of Arch Linux, and
provides you with a fully configured diving-board for work or more
customization. But PLARBS also works on already configured systems *and* other
...
Here are some of the things PLARBS sets up:
...
By default, PLARBS uses the programs [here in progs.csv](archi3/progs.csv) and installs
...
PLARBS will parse the given programs list and install all given programs. Note
...
phrase) that describes the program. During installation, PLARBS will print out
this information in a grammatical sentence. It also doubles as documentation
for people who read the csv or who want to install my dotfiles manually.

Depending on your own build, you may want to tactically order the programs in
your programs file. PLARBS will install from the top to the bottom.
...
PLARBS does to bypass this by default is to temporarily allow the newly created
