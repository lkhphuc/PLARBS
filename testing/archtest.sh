...
larbs() { curl -O https://raw.githubusercontent.com/lkhphuc/PLARBS/master/archdwm/plarbs.sh && bash plarbs.sh ;}
dialog --title "Install Phuc Le's Rice" --yesno "This install script will easily let you access Phuc Le's Auto-Rice Boostrapping Scripts (PLARBS) which automatically install a full Arch Linux i3-gaps desktop environment.\n\nIf you'd like to install this, select yes, otherwise select no.\n\nLuke"  15 60 && larbs
### END
